...
class App:
    ...
    def __init__(self):
        ...
        self.detx_label.pack(fill="x", pady=5)
        ...
        self.video_label.pack(fill="x", pady=5)
        ...
        self.audio_label.pack(fill="x", pady=5)
        ...
        try:
            if audio_file:
                ...
                cmd = [
                    ...
                    "-i", video_tmp,
                    "-i", audio_file,
                    "-c:v", "copy",      # Copier vidéo sans re-encoder
                    "-c:a", "aac",       # Réencoder seulement l'audio
                    "-shortest",         # Limiter à la plus courte durée
                    "-y",                # Overwrite sans demander
                    "-loglevel", "error", # Afficher juste les erreurs
                    output
                ]
            else:
                cmd = [
            ...
            # Exécuter ffmpeg avec capture d'erreurs
